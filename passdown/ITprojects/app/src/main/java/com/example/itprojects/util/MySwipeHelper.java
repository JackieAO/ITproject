/**
 *
 * Enable swipe functionality for a recycle view and can add options on it,when click the options
 * they can trigger onClick events
 *
 * @author  Team Perfect World
 * @version 8.0
 * @since   2019-09-07
 */
package com.example.itprojects.util;
...
/**
 * Attribute
 * Source: https://www.youtube.com/watch?v=Cam2AvfJilY,
 */
public abstract class MySwipeHelper extends ItemTouchHelper.SimpleCallback {
    ...
    private View.OnTouchListener onTouchListener = new View.OnTouchListener() {
        ...
        public boolean onTouch(View view, MotionEvent motionEvent) {
            ...
            RecyclerView.ViewHolder swipeViewHolder = recyclerView.
    ...
    public void onChildDraw(@NonNull Canvas c, @NonNull RecyclerView recyclerView, @NonNull
        ...
        super.onChildDraw(c, recyclerView, viewHolder, translationX, dY, actionState,
                isCurrentlyActive);
    }

    private void drawButton(Canvas c, View itemView, List<MyButton> buffer, int pos,
                            float translationX) {
    ...
    public abstract void instantiateMyButton(RecyclerView.ViewHolder viewHolder,
                                             List<MyButton> buffer);
    ...
    public class MyButton {
        ...
        public MyButton(Context context, String text, int textSize, int imageResId, int color,
